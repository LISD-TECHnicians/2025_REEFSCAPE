...
public final class Constants {
  ...
  public static class RobotConstants 
  {
    ...
    public static class SwerveDriveConstants
    {
      ...
      public static final double kPathTranslation_P = 4.5;
      public static final double kPathTranslation_I = 0.0; 
      public static final double kPathTranslation_D = 0.0;

      public static final double kPathRotation_P = 2.5;
      public static final double kPathRotation_I = 0.0; 
      public static final double kPathRotation_D = 0.0;
